...
CREATE TABLE "conversations" (
	...
	"status" varchar(20) DEFAULT 'bot_active' NOT NULL,
...
ALTER TABLE "conversations" ADD CONSTRAINT "conversations_assigned_operator_id_users_id_fk" FOREIGN KEY ("assigned_operator_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "contacts_tenant_phone_unique" ON "contacts" USING btree ("tenant_id","phone");